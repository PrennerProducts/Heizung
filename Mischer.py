RELAIS_AUF_PIN = 13                 # Pin fuer das Relais, das den Mischermotor in auf-Richtung ansteuert
RELAIS_ZU_PIN = 15                 # Pin fuer das Relais, das den Mischermotor in zu-Richtung ansteuert
